...
* Opening (Jason Nak)  
* Analogical reasoning (Denny Borsboom)

**Tuesday, July 7**

* Phenomena and concept specification (Markus Eronen & Laura Bringmann)  
* Exploratory theories (Willem Frankenhuis & Nicole Walasek)

**Wednesday, July 8**

* Theory specification (Andreas Glöckner)  
* Causal Loop Diagrams & Stock-and-flow modelling (Meike Waaijers & Kyra Evers)

**Thursday, July 9**

* Differential equation modelling  (Jonas Haslbeck)  
* Symposium: Contemporary perspectives on formalized theory in psychology

**Friday, July 10**

* Model creation and agent-based model (Han van der Maas)  
* Productive explanation (Noah van Dongen)
* Closing

## Requirements

This summer school is designed for participants at the doctoral (i.e., PhD) or postdoctoral level who possess familiarity with the R programming language. Participants are expected to bring their own laptop. Familiarity with mathematics beyond the high school level is not required. If you do not fulfill these requirements, registration is at your own risk. 
...
You can register for the waiting list via [this link](https://forms.cloud.microsoft/Pages/ResponsePage.aspx?id=zcrxoIxhA0S5RXb7PWh05VdsRYEQLS1Kh6tZxF6D6DZUMEhZUkhYTTlVTkk1WTJGRjRDTlNRM0NPNi4u). Please note that participants will be selected on a first-come, first-served basis, and registration is only confirmed after you have received an email from us. 

## Stay Informed

If you don’t want to register yet but do want to receive updates on the summer school, sign up for the mailing list [here](https://docs.google.com/forms/d/e/1FAIpQLSfeUD7QctGK_D8mIpZOieELN3s_xCgUp5fKk_v2umPz9av3jA/viewform?usp=dialog).
